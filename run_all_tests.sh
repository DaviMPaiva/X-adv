...
#vanila
python test_ssd.py --dataset "OPIXray" --model_arch "original" --ckpt_path save/OPIXray/original/ssd300_Xray_knife_50.pth  --phase results_vanila/OPIXray/iron/fix_patch/original/adver_image
python test_ssd.py --dataset "OPIXray" --model_arch "DOAM" --ckpt_path save/OPIXray/DOAM/ssd300_Xray_knife_50.pth  --phase results_vanila/OPIXray/iron/fix_patch/DOAM/adver_image
python test_ssd.py --dataset "OPIXray" --model_arch "LIM" --ckpt_path save/OPIXray/LIM/ssd300_Xray_knife_50.pth  --phase results_vanila/OPIXray/iron/fix_patch/LIM/adver_image


#ponto extra:
python test_ssd.py --dataset "OPIXray" --model_arch "original" --ckpt_path save/OPIXray/original/ssd300_Xray_knife_50.pth  --phase results_patch/OPIXray/iron/fix_patch/original/adver_image
python test_ssd.py --dataset "OPIXray" --model_arch "DOAM" --ckpt_path save/OPIXray/DOAM/ssd300_Xray_knife_50.pth  --phase results_patch/OPIXray/iron/fix_patch/DOAM/adver_image
python test_ssd.py --dataset "OPIXray" --model_arch "LIM" --ckpt_path save/OPIXray/LIM/ssd300_Xray_knife_50.pth  --phase results_patch/OPIXray/iron/fix_patch/LIM/adver_image