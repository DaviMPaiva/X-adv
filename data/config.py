...
CLCXray_train = {
    ...
    "dataset_root": "datasets/CLCXray/train",
    "imagesetfile": "datasets/CLCXray/train/clcxray_train.txt",
}
...
CLCXray_test = {
    ...
    "dataset_root": "datasets/CLCXray/test",
    "imagesetfile": "datasets/CLCXray/test/clcxray_test.txt",
}
