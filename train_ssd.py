...
parser.add_argument(
    ...
    default="original",
    type=str,
    choices=["original", "DOAM", "LIM"],
    help="Model architecture",
)
parser.add_argument(
    "--batch_size", default=24, type=int, help="Batch size for training"
)
parser.add_argument(
    "--resume",
    default=None,
...
def train():
    ...
    if args.dataset == "OPIXray":
        ...
        data_info = config.CLCXray_train
    ...
    for iteration in range(args.start_iter, cfg["max_iter"]):
        if iteration != 0 and (iteration % epoch_size == 0):
            ...
            if epoch % 5 == 0:
                ...
                torch.save(
                    ssd_net.state_dict(),
                    args.save_folder + "/ssd300_Xray_knife_" + repr(epoch) + ".pth",
                )
        ...
        if iteration % 10 == 0:
            ...
            print(
                "iter " + repr(iteration) + " || Loss: %.4f ||" % (loss.item()), end=" "
            )
